(function(t, e) {
    var s = e.body
      ...
      , x = {
        goTop: function(e) {
            var i = $()
              , s = arguments.length > 2 ? arguments[1] : Math.abs(i - e) / m;
            i && i > e ? (t.scrollTo(0, Math.max(i - s, 0)),
            v(arguments.callee.bind(this, e, s))) : e && i < e ? (t.scrollTo(0, Math.min(i + s, e)),
            v(arguments.callee.bind(this, e, s))) : this.toc.actived(e)
        },
        ...
        toggleMenu: function(e) {
            var i = a("#main");
            if (e) {
                if (l.classList.remove("hide"),
                t.innerWidth < 1241)
                    if (d.classList.add("in"),
            ...
            } else if (l.classList.remove("show"),
        ...
        toc: function() {
            ...
            return t.querySelector('a[href="#' + n[0].id + '"]').parentNode.classList.add("active"),
            {
                ...
                actived: function(e) {
                    ...
                    e < w(n[0]).y && (t.querySelector("li.active").classList.remove("active"),
                    t.querySelector('a[href="#' + n[0].id + '"]').parentNode.classList.add("active"))
                }
            }
        }(),
        hideOnMask: [],
        ...
        waterfall: function() {
            t.innerWidth < 760 || g.call(n(".waterfall"), function(t) {
        ...
        lightbox: function() {
            function i(i) {
                ...
                this.addTitle = function() {
                    this.title && (this.$caption = e.createElement("div"),
            ...
            g.call(n(".img-lightbox"), function(t) {
                new i(t)
            })
        }(),
    ...
    var E = !1
      , T = a('a[href^="mailto"]');
    T && T.addEventListener(L, function() {
        E = !0
    }),
    ...
    c.addEventListener(L, function() {
        v(x.goTop.bind(x, 0))
    }, !1),
    h.addEventListener(L, function(t) {
        x.toggleMenu(!0),
        t.preventDefault()
    }, !1),
    ...
    d.addEventListener(L, function(t) {
        x.toggleMenu(),
    ...
    Waves.attach(".article-tag-list-link, #page-nav a, #page-nav span", ["waves-button"])) : console.error("Waves loading failed.")
}
)(window, document);
